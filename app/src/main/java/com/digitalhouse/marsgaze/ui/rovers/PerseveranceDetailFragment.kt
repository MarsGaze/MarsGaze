...
import com.digitalhouse.marsgaze.databinding.FragmentPerseveranceDetailBinding
import com.digitalhouse.marsgaze.databinding.FragmentSpOpDetailBinding

class PerseveranceDetailFragment : Fragment() {

    var _binding: FragmentPerseveranceDetailBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentPerseveranceDetailBinding.inflate(inflater, container, false)
